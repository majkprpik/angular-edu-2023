...
@NgModule({
  declarations: [LoginComponent, DashboardComponent, LjuljComponent, ProductComponent, ProductsComponent,DizajnComponent, TestPipe, CartProductsComponent, CartComponent ],
  imports: [CommonModule, LjuljRoutingModule, FormsModule, HttpClientModule, MatButtonToggleModule,
    JwtModule.forRoot({
    config: {
      tokenGetter: tokenGetter,
      allowedDomains: ['localhost:4200'],
  ...
  providers: [AuthGuard,AuthService,UserService,CartService,ProductService,ProductResolver]
})
